						...
						<tbody id="MyPage_center2">
							<tr height="20%" >
								<th
									...
									width="100">작성자</th>
								<th style="padding: 10px"><input type="text" value="${memName}" disabled/></th>
							</tr>
							<tr>
															<th
									style="font-size: 15px; text-align: center; background-color: #212529; color: white;"
									width="100">제목</th>
								<th style="padding: 10px"><input type="text" style="width:300px;" name="productReviewTitle" /></th>
							</tr>
							<tr height="90%">
								<th
							...
							<tr>
								<th
									style="font-size: 15px; background-color: #212529; color: white; text-align: center; height: 300px;"
									width="100">파일첨부</th>
								<td style="background-color: white; height:50px;"><input type="file"
									onchange="readURL(this);" name="reviewFile"
									style="padding-top: 25px; float:left; "><img id="preview" style="float:right;" 
