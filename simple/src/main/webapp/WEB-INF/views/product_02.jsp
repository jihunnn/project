	...
	<section class="ftco-section" style="padding-top: 20px;">
					...
					<div class="col-md-4 ftco-animate">
						...
						<form name="form" method="get">
							<div>
								...
								<input type="text" name="amount" value="1" readonly="readonly"
									onchange="change();"
						...
						<form name="form1" method="post"
							action="${contextPath}/favoriteproduct.do">
							<input type="hidden" name="productNum"
								value="${product.productNum}">
							<button type="submit" onclick="favoriteproduct()"
		...
		<script type="text/javascript">
				...
				$(document).ready(function() {
					...
					$("#tab2").load("${contextPath}/product/listProductReview.do");
					$("#tab4").load("${contextPath}/product/listProductReview.do");
				...
				$(document).ready(function() {
					...
					var getAr0 = url.indexOf("Review");
				    var getAr1 = url.indexOf("board");
		...
		<ul class="nav  tabs" style="margin-top: 100px;">
			<li role="presentation" class="active" 
				style="width: 290px; text-align: center;"><a href="#tab1" rel="tab1"
				style="font-size: 23px; color: black; " >상품상세정보</a></li>
			<li role="presentation" style="width: 290px; text-align: center;"><a
				href="#tab2" rel="tab2"style="font-size: 23px; color: black;"  >고객후기</a></li>
			<li role="presentation" style="width: 290px; text-align: center;"><a
				href="#tab3" rel="tab3"style="font-size: 23px; color: black;">AS/배송/반품안내</a></li>
			<li role="presentation" style="width: 290px; text-align: center;"><a
						...
						<tr>
							<td
								style="border: 1px solid grey; padding-top: 30px; padding-left: 0px;"><button
									type="button" class="btn btn-default" onClick="productRiview()"
