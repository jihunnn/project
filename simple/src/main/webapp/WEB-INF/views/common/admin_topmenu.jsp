...
<body>
			<table
				...
				<tr style="font-weight: bold; font-size: 15px; height:19px; color:black;">
					<td style="padding-left:40px;">상품</td>
					<td style="padding-left:40px;">회원</td>
					<td style="padding-left:40px;">주문</td>
					<td  style="padding-left:40px;">게시판</td>
					<td  style="padding-left:40px;">기타</td>
				</tr>
				...
				<tr style="height: 25px;  cursor:pointer;">
					...
					<td style="padding-left:30px;"></td>
					<td style="padding-left:30px;"></td>
					<td style="padding-left:30px;"><a onclick="location.href='${contextPath}/board/listInquiry.do'">ㆍ1:1문의</a></td>
					<td style="padding-left:30px;"></td>
				</tr>
				<tr style="height: 25px;  cursor:pointer;">
					<td style="padding-left:30px;"></td>
