					...
					<table border="1"
						...
						<tbody id="MyPage_center2">
							...
							<c:choose>
								...
								<c:when test="${!empty mypageReturnList}">
									<c:set var="num"
										value="${pageMaker.totalCount - ((mypageReturnMap.pageNum-1) * 10) }" />
									<c:forEach var="mypageReturnList" items="${mypageReturnList}">
										<tr height="80%">
											...
											<th style="padding: 10px; text-align: center;"
												...
												<div>
													<img src="${contextPath}/resources/images/image_1.jpg"
														...
														style="margin-left: 0px; padding-right: 10px;">${mypageReturnList.productName}</a>
											...
											<th style="text-align: center;"><a id="now-state"
												...
												onclick="location.href='${contextPath}/mypage/viewReturn.do?returnNum=${mypageReturnList.returnNum}'" value="반품상세보기"></th>
										</tr>
									</c:forEach>
								</c:when>
							</c:choose>
